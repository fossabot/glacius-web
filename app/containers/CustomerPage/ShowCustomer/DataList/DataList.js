...
const columns = [
  ...
  { dataField: 'contact.email', text: 'Email', sort: true },
  { dataField: 'contact.first_name', text: 'First Name', sort: true },
  { dataField: 'contact.last_name', text: 'Last Name', sort: true },
  { dataField: 'contact.phone', text: 'Phone', sort: true },
